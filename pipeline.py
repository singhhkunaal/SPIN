...
For each spend category below, provide industry-standard savings benchmarks:
...
def run_pipeline(
    ...
    Returns (output_xlsx_bytes, suggested_filename).
    """
    ...
    return out_buf.getvalue(), suggested_filename
